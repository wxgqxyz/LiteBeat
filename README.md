...
当前完成 **T01 工程基线**、**T02 数据库层**（SQLite 模式、迁移命令、2 读/1 写有界工作队列）、**T03 登录与会话**（Argon2id、CSRF、限流）与 **T04 原文件播放**（完整 HTTP Range 语义、全局/会话流配额、30s 无进展超时）。音乐库扫描、曲库检索等按 [实施路线](./03-delivery-and-validation.md) 的 T05–T11 逐步交付。
